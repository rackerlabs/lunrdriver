...
class VolumeSnapshotTest(BaseVolumeTestCase):
	
	def setUp(self):
	    super(VolumeSnapshotTest, self).setUp()
	...
	def tearDown(self):
	    super(VolumeSnapshotTest, self).tearDown()
	...
	def test_create_snapshot_limit(self):
		...
		quota_snapshots_per_vol = CONF.lunr_total_snapshots_hard_limit
		CONF.lunr_total_snapshots_hard_limit = 1
		...
		CONF.lunr_total_snapshots_hard_limit = quota_snapshots_per_vol
